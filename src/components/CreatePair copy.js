...
const getOtherTokenAndAmount = async(token, amount) => {
        let tokenOut =await props.poolContract.getLiquidityAmount(token, utils.parseEther(amount.toString()))
  ...
  return (
    <Container>
        ...
        <SwapBox>
            ...
            {toggle > 0 && (props.poolData.initialized  ? (<button onClick={toggleAddRemoveLiquidity}>add/remove liquidity</button>) : "Initialize")}
            ...
            (<>
                ...
                {addRemoveLiquidity.value 
                    ...
                    <SwapInput>
                        ...
                        your LP token balance: {utils.formatEther(props.poolData.liquidityTokens)}
